...
function ServiceCard({ icon, title, text, href }: Card) {
  return (
    <div class="feature-card card-services rounded-none  px-[30px] group group-hover:-translate-y-3 w-[auto] max-md:w-full bg-[#FFFFFF]  items-start h-auto relative mb-[100px] max-md:mb-[10px]">
      {icon && (
      ...
      <a href={href} class="arrow-link bgwhite">
...
export default function Services({ title, cards }: Props) {
  return (
    <section class="relative text-[#1a1a1a]  max-w-screen">
      <div class="container relative py-[139px] pb-[139px]  max-md:py-[30px] max-md:pb-[30px] rounded-[30px] lg:px-[5%] max-md:px-[10px]">
        <svg
          class="absolute left-0 top-[-120px]"
          width="100vw"
          height="979"
        ...
        >
          <path
            d="M-93 688.28C133.559 589.304 456.352 566.612 632.832 652.07C809.313 737.527 991.223 945.362 624.687 977.244C258.151 1009.13 707.044 22.7265 2013 1"
            stroke="#353535"
            stroke-width="1.11111"
          />
        </svg>
        <div class="text-sm text-[#fc6001] font-[500] px-6 border-b-[1px] container pb-6">
          <span>SERVIÇOS DE DESENVOLVIEMNTO</span>
        </div>
        <div class="container lg:mx-auto flex justify-between items-center flex-col gap-20">
          ...
          <div class="grid grid-cols-4 max-lg:grid-cols-2 w-full max-sm:grid-cols-1">
